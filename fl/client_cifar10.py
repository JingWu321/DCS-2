...
class MNISTClient(fl.client.NumPyClient):
    def __init__(self, net, args, device):
        ...
        self.net = net
        self.args = args
        self.trainloader, self.testloader, self.num_examples, self.proxyloader = load_data(args)
        ...
        self.optimizer = torch.optim.SGD(self.net.parameters(), lr=args.train_lr, momentum=0.9, weight_decay=1e-3)
